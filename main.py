...
detector.prepare(0, blur_threshold=50)
adaface_model_path = os.path.join(assets_dir, './Adaface/R50/F32/model.xml')
...
if __name__ == '__main__':
    ...
    compare_video_detailed('videos/input/39837-424360872_small.mp4', threshold=0.4, output_path='videos/docker.mp4')
    # compare_video_detailed('videos/input/BLR_Station.mp4', threshold=0.4, output_path='videos/output/ov/BLR_Station_gpu_npu_1_blur_both_fp16.mp4')
