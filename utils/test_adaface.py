...
# ---------------------------------------------------------------------
assets_dir          = os.path.expanduser('/home/sr/ov_fr/buffalo_l')     # model folder
embeddings_jsonl    = "/home/sr/ov_fr/final_embeddings_adaface_ov_fp16.jsonl"         # existing JSONL
test_image_path     = "/home/sr/ov_fr/videos/input/BLR_Railway/BLR_12345_006.png"
# ---------------------------------------------------------------------
